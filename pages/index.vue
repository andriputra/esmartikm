<template>
  <div>
    <div class="container">
      ...
      <div
        class="py-5 px-10 rounded-lg flex flex-col gap-5 text-lg mb-10 text-home"
      >
        <p>
      ...
      <ul class="flex flex-wrap justify-center gap-5">
        <!-- <li>
          <a
            href="https://www.instagram.com/bank_indonesia_bengkulu"
            target="_blank"
            rel="nofollow"
            class="text-primary-800 hover:text-primary-700"
          >
            <svg-icon name="instagram-alt" />
            @bank_indonesia_bengkulu
          </a>
        </li>
        <li>
          <a
            href="https://www.youtube.com/@bankindonesiabengkulu545"
            target="_blank"
            rel="nofollow"
            class="text-primary-800 hover:text-primary-700"
          >
            <svg-icon name="youtube" />
            bankindonesiabengkulu545
          </a>
        </li> -->
        <li>
          <a
    ...
    <div
      v-if="false"
      class="bg-primary-500 lg:bg-transparent bg-opacity-10 px-10 lg:px-0 relative py-12 my-16"
    >
      <div
      ...
      <div class="container">
        <div class="lg:max-w-2xl flex flex-col lg:flex-row items-start gap-10">
          ...
          <div class="flex flex-col items-start">
            <div class="text-4xl text-primary-600">E-Katalog Bengkulu</div>
            <p class="text-2xl mt-4">Produk IKM Unggulan Bengkulu</p>
            <a
